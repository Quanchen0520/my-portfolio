...
export default function QuanWatchlistPage() {
  return (
    <main className="min-h-screen bg-[#0F172A] text-slate-200 px-6 py-16">
      <ViewCounter slug="quan-watchlist" />
      <div className="max-w-3xl mx-auto">
        ...
        <header className="mt-6 mb-10">
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">QuanWatchlist</h1>
          <p className="text-slate-400 mt-4 leading-relaxed">本地端看盤小工具，方便快速追蹤自選股票與市場動態。</p>
        </header>
        ...
        <section className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-3 mt-6">
            <a
              href="https://github.com/Quanchen0520/QuanWatchlist"
              target="_blank"
            ...
            <a
              href="https://quanwatchlist.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm text-sky-400 hover:text-sky-300 transition-colors"
            >
        ...
        <section className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 mb-8">
          ...
          <div className="relative w-full aspect-[16/10] overflow-hidden rounded-lg border border-slate-800">
            <Image
              src="/quan-watchlist_image/quan-watchlist_image1.png"
              alt=" QuanWatchlist 畫面預覽"
              fill
              className="object-cover border border-slate-700 rounded-lg"
              priority
            />
          </div>
          <p className="text-sm text-slate-400 mt-3">首頁，自選股票總覽。</p>
